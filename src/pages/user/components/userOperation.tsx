...
`;
const list = [
  { icon: 'icon-bianji', title: '用户信息修改', toRedirect: '/main/sub/userChange' },
  { icon: 'icon-anquanyanzheng', title: '重置密码', toRedirect: '/main/sub/modifyPassword' },
  { icon: 'icon-renwu', title: '关于我们', toRedirect: '/main/sub/aboutUs' },
];
const OperationUser = () => {
