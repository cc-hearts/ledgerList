...
export const UserInfoContext = React.createContext<{ info: Record<string, unknown> | null; clearUserInfo: (() => void) | null } | null>(null);

export const LayoutIndex: React.FC<Props> = ({ children }) => {
  useGuard();
  const [info, clearUserInfo] = useUserInfo();
  return (
    <UserInfoContext.Provider value={{ info, clearUserInfo }}>
      {children}
